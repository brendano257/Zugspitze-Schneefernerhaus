"""
Three sets of (CC416168, EMPA SX3555, Blank2500) were run in sequence to quantify the EMPA standard and vice versa.
"""
__package__ = 'Z'
...
blank_2500_set = (session.query(GcRun)
                  ...
                  .filter(GcRun.date > datetime(2019, 3, 20), GcRun.date < datetime(2019, 3, 21))
