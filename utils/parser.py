...
def parser():
    """
    Creates and runs an argument parser.

    :return None: Import and run parser to use this parser elsewhere.
    """
    p = argparse.ArgumentParser(description='Run part of all of the Zugpsitze Runtime in sequence.')
    p.add_argument('-A', '--all', action='store_true')  # flag to run everything in sequence
